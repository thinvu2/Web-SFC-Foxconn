  ...
  <div class="div-all">
    <div class="row">
      ...
      <div class="div-config-name row">
        <span>Modify route description:</span>
      </div>
    </div>
    ...
    <div class="div-bellow">
      <div class="form-row">
        <div class="col-md-4 mb-4">
          <label for="validationDefault02">ROUTE_CODE </label>
          <input
            class="form-control form-control-sm text-element" 
            type="text"
            :value="model.ROUTE_CODE"
            textPlaceHolder="Enter ROUTE_CODE"
        ...
        <div class="col-md-4 mb-4">      
          ...
          <input
            ...
            textPlaceHolder="Enter ROUTE_NAME"
            v-on:change="UpdateVersionReceive" 
            :disabled="isDisabled"
          />  
        </div>
        <div class="col-md-4 mb-4">
            <label for="validationDefault02">ROUTE_DESC</label>
          <input
            class="form-control form-control-sm text-element" 
            style="min-height :31px;"
            type="text"
            :value="model.ROUTE_DESC"
            textPlaceHolder="Enter ROUTE_DESC"
            v-on:change="UpdateROUTE_DESC" 
          />  
        </div>
...
export default {
  ...
  mounted() {
    document.title = "Modify route description";
    this.CheckPrivilege();
    this.GetModel();
  },
  methods: {
    UpdateModelReceive(value) {
        ...
        this.model.ROUTE_DESC = "";    
    },    
    UpdateROUTE_DESC: function(event) {
      this.model.ROUTE_DESC = event.target.value;     
    },     
    ...
    async GetModel() {
      ...
      var { data } = await Repository.getRepo("ConfigMake_WeightModel", payload);
    ...
    async SaveData() {
      ...
      if (this.model.ROUTE_DESC == "") {
        ...
        this.$swal({
          ...
          var { data } = await Repository.getRepo("InsertUpdateRoute_Description",this.model);
    ...
    ShowDetail(detail) {
        ...
        this.model.ROUTE_DESC = detail.ROUTE_DESC; 
    },
    BackToParent() {
    ...
    async LoadComponent() {
      ...
      var { data } = await Repository.getRepo("GetRoute_NameContent", payload);
      this.DataTable = [];
