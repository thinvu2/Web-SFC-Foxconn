  ...
  <div class="div-all">
    ...
    <div class="div-bellow">
      <div class="form-row">
        ...
        <div class="col-md-3 mb-3">
          <label for="validationDefault02">LABEL 3S</label>
          <DropdownSearch
            class="form-control form-control-sm text-element col-md-3"
            :listAll="Liststatus"
            ...
            type="model"
            textPlaceHolder="Enter label 3s"  />
        </div>
...
export default {
  ...
  methods: {
    ...
    UpdateModelReceive(value) {     
      ...
      this.Liststatus = [];
      this.Liststatus.push("Confirm to 3S");
      this.Liststatus.push("Confirm to Remove");      
    },    
    ...
    async SaveData() {
      if (this.model.MODEL_NAME == "" || this.model.VERSION_CODE == "" || this.model.STATUS == "") {
    ...
    async CheckPriLabel3s(value,model) {
      ...
      if (data.result != "ok") {        
        ...
        if(value == "CONFIG_NIC3S"){
            ...
            this.model.VERSION_CODE = model.VERSION_CODE;
            this.model.STATUS = model.STATUS;
            this.Liststatus = [];
            this.Liststatus.push("OK 3S");
    ...
    async LoadComponent() {
      ...
      var { data } = await Repository.getRepo("GetConfigLabel3SContent", payload);
      this.DataTable = [];
