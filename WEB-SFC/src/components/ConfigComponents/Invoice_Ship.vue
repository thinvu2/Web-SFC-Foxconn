    ...
    <div class="div-all">
      ...
      <div class="div-bellow">
        ...
        <div class="form-row">
          ...
          <div class="col-md-3 mb-3">
            <label for="validationDefault02">DELIVERY_NO</label>
            <input
              type="text"
              class="form-control form-control-sm text-element"
              id="validationDefault02"
  ...
  limitInputLength(event, maxLength){
    ...
    if (
      ...
      ShowDetail(item) {
        ...
        this.model.DELIVERY_NO = item.DELIVERY_NO;
...
addTos.forEach((addr, index) => {
  ...
  if(index == 7){
    if (addr === null || addr === undefined || addr.trim() === "") {
      SHIP_ADDRESS += "DELIVERY_NO:";
    }
    else{
      SHIP_ADDRESS += "DELIVERY_NO:" + addr.trim();
    }
  } else if(index == 8){
    if (addr === null || addr === undefined || addr.trim() === "") {
      SHIP_ADDRESS += "DATA1:";
