<template>
  <div class="div-all">
            ...
            <thead>
              <tr>
                ...
                <th style="width: 1px">
                  ...
                  <th style="width: 1px">
                  {{ $store.state.language == "En" ? "Verify" : "Sửa" }}
                </th>
              ...
              <tr>
                ...
                <td class="td-edit" @click="ShowDetail(item)">
                  ...
                  >
                    ...
                    <path
                      fill="#FFF"
                      d="M16.757 3l-2 2H5v14h14V9.243l2-2V20a1 1 0 0 1-1 1H4a1 1 0 0 1-1-1V4a1 1 0 0 1 1-1h12.757zm3.728-.9L21.9 3.516l-9.472 9.472-1.412.003-.002-1.417L20.485 2.1z"
                    />
                  </svg>
                </td>
                 <td class="td-edit1" @click="ShowDetail_Verify(item)">
                    <svg version="1.1" id="Capa_1"  xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
                      viewBox="0 0 52 52" style="enable-background:new 0 0 52 52;width: 30px ;   height: 24px;" xml:space="preserve" >
                    <g>
                      ...
                      <path  fill="#FFF"  d="M38.252,15.336l-15.369,17.29l-9.259-7.407c-0.43-0.345-1.061-0.274-1.405,0.156c-0.345,0.432-0.275,1.061,0.156,1.406
    ...
    <div class="div-button">
      ...
      >
        ...
        >
          ...
          <path
            fill="red"
            d="M5.473 4.433A9.961 9.961 0 0 1 12 2c5.523 0 10 4.477 10 10 0 2.136-.67 4.116-1.81 5.74L17 12h3A8 8 0 0 0 6.47 6.228l-.997-1.795zm13.074 15.134A9.961 9.961 0 0 1 12 22C6.477 22 2 17.523 2 12c0-2.136.67-4.116 1.81-5.74L7 12H4a8 8 0 0 0 13.54 5.772l.997 1.795z"
          />
        </svg>
      </button>
    </div>
    <div class="div-bellow">
      <div class="form-row">
        <div class="col-md-4 mb-3" v-show="!show">
        ...
        <div class="col-md-4 mb-3" v-show="!show">
          <label for="validationDefault02">PORT TYPE</label>
           <DropdownSearch
            class="form-control form-control-sm text-element col-md-3"
            :listAll="ListPort"
            @update-selected-item="UpdatePortReceive"
            :textContent="model.PORT_TYPE"
        ...
        <div class="col-md-4 mb-3" v-show="show1">
          <label for="validationDefault01">MO TYPE</label>
      ...
      <div class="form-row">
        ...
        <div class="col-md-4 mb-3">
          <label for="validationDefault02">STATION TYPE</label>
          <input
            type="text"
            class="form-control form-control-sm text-element"
            id="validationDefault01"
            v-model="model.STATION_TYPE"
            required
            :readonly="isReadonly_1==true"

          />
        </div>

        <div class="col-md-4 mb-3" id ="dropdown1">
          <label for="validationDefault01">STATUS</label>
           <br/>
          <select
            @keyup="keyUpData()"
            v-model="model.STATUS"
            class="form-control form-control-sm text-element col-md-3" id ="dropdown1"
          >
...
export default {
  ...
  methods: {
    ...
    UpdatePortReceive(value){
            this.model.PORT_TYPE=value;
    },
    async GetModel() {
      var payload = {
        database_name: localStorage.databaseName,
    ...
    GetPort_Status()
    {
      this.ListStatus.push("1");
      this.ListStatus.push("0");

      this.ListPort.push("1");
      this.ListPort.push("2");

      this.ListMotype.push("NORMAL");
      this.ListMotype.push("REWORK");
    ...
    async SaveData() {
      if (this.model.MODEL_NAME == "" || this.model.STATION_TYPE == ""||  this.model.STATION_TYPE == "" ||
      this.model.MO_TYPE == "" || this.model.PORT_TYPE == "" || this.model.GROUP_NAME=="")
       {
    ...
    DeleteRecord(item) {
      ...
      this.$swal({
        ...
        var { data } = await Repository.getRepo("DeleteConfig52", payload);
        if (data.result == "ok") {
          await this.QuerySearch();
          if (localStorage.language == "En") {
            this.$swal("", "Apply successfully", "success");
    ...
    ClearForm() {
      ...
      //this.GetModel();
      this.model.MO_TYPE=""
      this.model.STATION_TYPE = "";      
      this.model.GROUP_NAME = "";
      this.model.PORT_TYPE = "";
      this.model.STATUS="";
    ...
    ShowDetail(detail) {
      ...
      this.model.STATION_TYPE = detail.STATION_TYPE;
      this.model.PORT_TYPE = detail.PORT_TYPE;
      ...
      console.log("readoly:"+ this.isReadonly);
    },

    ShowDetail_Verify(detail) {
    ...
    async LoadComponent() {
      ...
      var { data } = await Repository.getRepo("GetConfig52Content", payload);
      this.DataTable = [];
