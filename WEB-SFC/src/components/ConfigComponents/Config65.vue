      ...
      <div class="div-bellow">
        <div class="form-row">
          ...
          <div class="col-md-3 mb-3">
            <label for="validationDefault02">PASS_LIMIT</label>
            <input
              type="number"
              class="form-control form-control-sm text-element"
              id="validationDefault02"
              v-model="model.PASS_LIMIT"
          ...
          <div class="col-md-3 mb-3">
            <label for="validationDefault02">RETEST_LIMIT</label>
            <input
              type="number"
              class="form-control form-control-sm text-element"
              id="validationDefault02"
              v-model="model.RETEST_LIMIT"
              required
            />
          </div>
          <div class="col-md-3 mb-3">
            <label for="validationDefault02">RETEST_MODEL</label>
            <input
              type="number"
              class="form-control form-control-sm text-element"
              id="validationDefault02"
              v-model="model.RETEST_MODEL"
              required
            />
          </div>
          <div class="col-md-3 mb-3">
            <label for="validationDefault02">REPASS_MODEL</label>
            <input
              type="number"
              class="form-control form-control-sm text-element"
              id="validationDefault02"
              v-model="model.REPASS_MODEL"
              required
            />
          </div>
        </div>
        ...
        <!-- <div class="form-row">
          <div class="col-md-3 mb-3">
            <label for="validationDefault02">DPPM</label>
            <input
              type="number"
              class="form-control form-control-sm text-element"
              id="validationDefault02"
  ...
  export default {
    ...
    methods: {
      ...
      async GetModel() {
        ...
        var { data } = await Repository.getRepo("GetConfigMODEL65Content", payload);
       ...
       async GetGroupName() {
        ...
        data.data1.forEach((element) => {
          this.ListPreGroup.push(element.GROUP_NAME);
      ...
      async GetPassLimit() {
        ...
        var { data } = await Repository.getRepo("GetallPassLimitCF45", payload);
        data.data.forEach((element) => {
          this.ListNextGroup.push(element.PASS_LIMIT);
        });
      },
      ...
      async SaveData() {
        if (this.model.MODEL_NAME == "" || this.model.GROUP_NAME == "" || this.model.PASS_LIMIT == ""
        || this.model.RETEST_LIMIT == "" 
        ) {
      ...
      DeleteRecord(item) {
        ...
        this.$swal({
          ...
          var payload = {
            ...
            PASS_LIMIT : item.PASS_LIMIT,
            RETEST_LIMIT : item.RETEST_LIMIT,
            DDPM : "",
          };
          var { data } = await Repository.getRepo("DeleteConfig65", payload);
          if (data.result == "ok") {
            await this.QuerySearch();
            if (localStorage.language == "En") {
              this.$swal("", "Apply successfully", "success");
      ...
      ClearForm() {
       ...
       this.model.PASS_LIMIT= '';
       this.model.RETEST_LIMIT='';
       this.model.REPASS_MODEL= '';
       this.model.RETEST_MODEL='';
      ...
      ShowDetail(detail) {
         ...
         this.model.PASS_LIMIT= detail.PASS_LIMIT;
         this.model.RETEST_LIMIT= detail.RETEST_LIMIT;         
       this.model.REPASS_MODEL=detail.REPASS_MODEL;         
       this.model.RETEST_MODEL=detail.RETEST_MODEL;         
      ...
      async LoadComponent() {
        ...
        var { data } = await Repository.getRepo("GetConfig65Content", payload);
        this.DataTable = [];
