  ...
  <div class="div-all">
    <div class="row">
      ...
      <div class="div-config-name row">
        <span>Config Repair Rule (46):</span>
      </div>
    </div>
    ...
    <div class="div-bellow">
      <div class="form-row">
        ...
        <div class="col-md-3 mb-3">
          <label for="validationDefault01">REPAIR DAY</label>
          <input
            type="number"
            class="form-control form-control-sm text-element"
            id="validationDefault01"
            v-model="model.REPAIR_DAY"
            required
          />
        </div>
        <div class="col-md-3 mb-3">
          <label for="validationDefault01">REPAIR COUNT</label>
          <input
            type="number"
            class="form-control form-control-sm text-element"
            id="validationDefault01"
            v-model="model.REPAIR_COUNT"
            required
          />
        </div>
      </div>
      ...
      <div class="form-row">
        <div class="col-md-3 mb-3">
          <label for="validationDefault02">LOCATION COUNT</label>
          <input
            type="number"
            class="form-control form-control-sm text-element"
            id="validationDefault02"
            v-model="model.LOCATION_COUNT"
            required
          />
        </div>
        <div class="col-md-3 mb-3">
...
export default {
  ...
  methods: {
    ...
    async GetCustomer() {
      ...
      var { data } = await Repository.getRepo("Config46GetCustomer", payload);
    ...
    DeleteRecord(item) {
      ...
      this.$swal({
        ...
        var { data } = await Repository.getRepo("DeleteConfig46", payload);
        if (data.result == "ok") {
          await this.QuerySearch();
          if (localStorage.language == "En") {
            this.$swal("", "Apply successfully", "success");
    ...
    ClearForm() {
      ...
      this.model.REPAIR_DAY = "";
      this.model.REPAIR_COUNT = "";
      this.model.LOCATION_COUNT = "";
      this.model.STATUS = "1";
    },
    ShowDetail(detail) {
      ...
      this.model.REPAIR_DAY = detail.REPAIR_DAY;
      this.model.REPAIR_COUNT = detail.REPAIR_COUNT;
      this.model.LOCATION_COUNT = detail.LOCATION_COUNT;
    ...
    async LoadComponent() {
      ...
      var { data } = await Repository.getRepo("GetConfig46Content", payload);
      this.DataTable = [];
