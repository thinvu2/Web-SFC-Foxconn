  ...
  <div class="div-all">
    <div class="row">
      ...
      <div class="div-config-name row">
        <span>Config Error Code Setup (8):</span>
      </div>
    </div>
    ...
    <div class="div-bellow">
      <div class="form-row">
        <div class="col-md-4 mb-3">
          <label for="validationDefault02">ERROR CODE</label>
          <input
            type="text"
        ...
        <div class="col-md-4 mb-3">
          <label for="validationDefault02">ERROR DESC</label>
          <input
            type="text"
            class="form-control form-control-sm text-element"
            id="validationDefault01"
            v-model="model.ERROR_DESC"
            required
          />
        </div>
        <div class="col-md-4 mb-3">
          <label for="validationDefault02">ERROR DESC2</label>
          <input
            type="text"
            class="form-control form-control-sm text-element"
            id="validationDefault01"
            v-model="model.ERROR_DESC2"
          />
        </div>
      </div>
    </div>
  ...
  methods: {
    ...
    DeleteRecord(item) {
      ...
      this.$swal({
        ...
        var { data } = await Repository.getRepo("DeleteConfig8", payload);
        if (data.result == "ok") {
          await this.QuerySearch();
          if (localStorage.language == "En") {
            this.$swal("", "Apply successfully", "success");
    ...
    ClearForm() {
      this.model.ID = "";
      this.model.ERROR_CODE = "";
      this.model.ERROR_DEGREE = "";
      this.model.ERROR_TYPE = "";
      this.model.ERROR_DESC = "";
      this.model.ERROR_DESC2 = "";
    },
    ShowDetail(detail) {
      this.model.ID = detail.ID;
      this.model.ERROR_CODE = detail.ERROR_CODE;
      this.model.ERROR_DESC = detail.ERROR_DESC;
      this.model.ERROR_DESC2 = detail.ERROR_DESC2;     
    },
    BackToParent() {
    ...
    async LoadComponent() {
      ...
      var { data } = await Repository.getRepo("GetConfig8Content", payload);
      this.DataTable = [];
