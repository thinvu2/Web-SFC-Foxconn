          ...
          this.$swal({
            ...
            if (data.result == "privilege" && data.result == "not_privilege") {
              if (localStorage.language == "En") {
                ...
                this.$swal("", "Ban khong co quyen them sua", "error");
              }
              ...
              if (localStorage.language == "En") {
                ...
                this.$swal("", "Cap nhat thanh cong", "success");
              }
              ...
              if (localStorage.language == "En") {
                ...
                this.$swal("", "Ðã ton tai du lieu", "error");
              }
            }else if (data.result == "notpass") {
              if (localStorage.language == "En") {
                this.$swal("", "Setup not privilege Confirm", "error");
              } else {
                this.$swal("", "Nguoi thiet lap không co quyen xác nhan", "error");
              }
            } else {
      ...
      async CheckPrivilege() {
        ...
        if (data.result != "ok") {
          if (localStorage.language == "En") {
            ...
            this.$swal("", "Ban không co quyen thêm sua", "error");
          }
