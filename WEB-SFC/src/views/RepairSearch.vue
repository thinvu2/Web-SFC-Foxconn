  ...
  <div class="div-export row">
    ...
    <div class="row">
      <template v-if="qmDataTable.length > 0">
        <div v-if="opt1 == true || opt2 == true || opt3 == true || opt4 == true || opt5 == true"></div>
...
export default {
  ...
  methods: {
    ...
    async modelClick() {
      ...
      var { data } = await Repository.getRepo("GetRepairElement", payload);
    ...
    queryQM() {
      if (this.opt1) {
        ...
        this.doQuery("DuppErrorCode");
      }else if (this.opt3) {
        this.doQuery("Querynotrepair");
      }else if (this.opt4) {
        this.doQuery("Query_R");
      }else if (this.opt5) {
        this.doQuery("QueryBonepile");
      }
    },
    async doQuery(typeSearch) {
      ...
      var dateTimeTo = "";
      if (this.timeFrom == "ALL") {
        dateTimeFrom = `${this.pad(this.dateFrom.getFullYear())}/${this.pad(
          this.dateFrom.getMonth() + 1
        )}/${this.pad(this.dateFrom.getDate())} 00:00`;
        dateTimeTo = `${this.pad(this.dateTo.getFullYear())}/${this.pad(
          this.dateTo.getMonth() + 1
      ...
      var payload = {
        ...
        date_to: dateTimeTo,
        option: typeSearch,
        group_list: this.$store.state.listSelectDualGroup,
        model_list: this.$store.state.listSelectDualModel,
        group_by: [
          {
            key: "SERIAL_NUMBER",
          },
      ...
      var { data } = await Repository.getRepo("GetRepair", payload);
