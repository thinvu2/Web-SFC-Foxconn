  ...
  <div class="div-main" style="background-color: #4e7da6">
    ...
    <div v-if="!isHideMenu">
      <div class="col-12 row" style="padding-top: 10px; padding-bottom: 5px">
        <template v-for="(item, index) in menuInv2" :key="index">
      ...
      <div class="top-left div-top col-12 row">
        ...
        <div class="col row select-div">
          ...
          <select
            ...
            class="form-control form-control-sm select-form"
          >
            <option value="IST">IN STATION TIME</option>
            <option value="ILT">IN LINE TIME</option>
            <option value="OLT">OUT LINE TIME</option>
            <option value="WD">WARRANTY DATE</option>
          </select>
        </div>
...
import ModalEnterElementQ6 from "../components/Modal/ModalEnterElementQInv2.vue";
