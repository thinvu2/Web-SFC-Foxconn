      ...
      if(!this.isTelit){
       if((this.byDN && this.period )||(!this.byDN && !this.period )){
            if (localStorage.language == "En") {
              ...
              this.$swal("", "Chọn ByDN hoặc ByCreat_time", "error");
            } 
            return;  
        }
        ...
        if(this.byDN == true){
          if (this.valueSearch.trim() == ""){
            if (localStorage.language == "En") {
              ...
              this.$swal("", "Không được để trống nhập DN", "error");
            } 
            return;  
          }
        }
        ...
        if(data.result == "ok"){
          ...
          if (localStorage.language == "En") {
            ...
            this.$swal("", "Không tồn tại dữ liệu", "error");
          } 
        }
      }else{
        if(this.valueSearch == "" || this.valueSearch == null){
            if (localStorage.language == "En") {
              ...
              this.$swal("", "Không được để input rỗng", "error");
            } 
            return;  
        }
        var payload1 = {
