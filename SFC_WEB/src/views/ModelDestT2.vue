  ...
  <div class="div-all">
    ...
    <div class="div-bellow">
      <div class="form-row">
        ...
        <!--
        <div class="col-md-3 mb-3">
          <label for="validationDefault01">VERSION_DESC</label>
          <input
            type="text"
            class="form-control form-control-sm text-element"
            id="validationDefault01"
            v-model="model.VERSION_DIFFERENCE"
            required
          />
        </div>-->
        <div class="col-md-3 mb-3">
          <label for="validationDefault01">MAC ON SFIS</label>
          <input
            type="text"
            class="form-control form-control-sm text-element"
            id="validationDefault01"
        ...
        <div class="col-md-3 mb-3">
          <label for="validationDefault01">MAC STEP(2nd)</label>
          <input
            type="text"
            class="form-control form-control-sm text-element"
            id="validationDefault01"
        ...
        <div class="col-md-3 mb-3">
          <label for="validationDefault01">SSN PREFIX</label>
          <input
            type="text"
            class="form-control form-control-sm text-element"
            id="validationDefault01"
        ...
        <div class="col-md-3 mb-3">
          <label for="validationDefault01">POSTFIX</label>
          <input
            type="text"
            class="form-control form-control-sm text-element"
            id="validationDefault01"
        ...
        <div class="col-md-3 mb-3">
          <label for="validationDefault01">LABEL_TYPE</label>
          <input
            type="text"
            class="form-control form-control-sm text-element"
            id="validationDefault01"
        ...
        <div class="col-md-3 mb-3">
          ...
          <input
            ...
            class="form-control form-control-sm text-element"
            id="validationDefault01"
            v-model="model.CUST_KP"
            required
          />
        </div>
        <div class="col-md-3 mb-3">
          <label for="validationDefault01">LENGHT</label>
          <input
            type="text"
            class="form-control form-control-sm text-element"
            id="validationDefault01"
        ...
        <div class="col-md-3 mb-3">
          <label for="validationDefault01">QTY</label>
          <input
            type="text"
            class="form-control form-control-sm text-element"
            id="validationDefault01"
...
export default {
  ...
  methods: {
    ...
    UpdateModelReceive(value) {
      ...
      this.model.PALLET_LAB_NAME = `${this.model.MODEL_NAME}`;
      this.model.CARTON_LAB_NAME = `${this.model.MODEL_NAME}`;
    },
    async GetModel() {
      var payload = {
        database_name: localStorage.databaseName,
      };
      var { data } = await Repository.getRepo("getDataModelDest", payload);
    ...
    async GetCustomer() {
      ...
      var { data } = await Repository.getRepo("getDataModelDestT2", payload);
      ...
      if (this.model.MODEL_NAME == "" || this.model.VERSION_CODE == "") {
        ...
        this.$swal({
          ...
          var payload = {
            ...
            VERSION_DIFFERENCE: this.model.VERSION_DIFFERENCE,
          };
          var { data } = await Repository.getRepo(
            "InsertUpdateDataModelDestT2",
            payload
          );
    ...
    DeleteRecord(item) {
      ...
      this.$swal({
        ...
        var { data } = await Repository.getRepo("DeleteDataModelDestT2", payload);
        if (data.result == "ok") {
          await this.QuerySearch();
          if (localStorage.language == "En") {
            this.$swal("", "Apply successfully", "success");
    ...
    ClearForm() {
      ...
      this.model.VERSION_DIFFERENCE = "";     
      this.model.STANDARD = "";        
      this.model.END_GROUP = "";  
      this.model.PRODUCT_NAME = "";
      this.model.CUST_KP = "";
      this.model.MODEL_RANGE2 = "";
    ...
    ShowDetail(detail) {
      ...
      this.model.VERSION_DIFFERENCE = detail.VERSION_DIFFERENCE;
      this.model.STANDARD = detail.PREFIX;            
      this.model.END_GROUP = detail.POSTFIX;      
      this.model.PRODUCT_NAME = detail.LABEL_TYPE;
      this.model.CUST_KP = detail.MATERIAL;
      this.model.MODEL_RANGE2 = detail.LENGHT;
      this.model.MODEL_TYPE = detail.MAC_ON_SFIS;
      this.model.CUSTOMER = detail.MAC_STEP;
      this.model.QTY = detail.QTY;
    },
    BackToParent() {
