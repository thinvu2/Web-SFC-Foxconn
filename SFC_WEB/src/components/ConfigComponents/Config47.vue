  ...
  <div class="div-all">
    <div class="row">
      ...
      <div class="div-config-name row">
        <span>Config Repair Version (47):</span>
      </div>
    </div>
    ...
    <div class="div-bellow">
      <div class="form-row">
        ...
        <div class="col-md-3 mb-3">
          <label for="validationDefault01">MODEL TYPE</label>
          <input
            type="text"
            class="form-control form-control-sm text-element"
...
export default {
  ...
  methods: {
    ...
    async GetCustomer() {
      ...
      var { data } = await Repository.getRepo("Config47GetCustomer", payload);
    ...
    DeleteRecord(item) {
      ...
      this.$swal({
        ...
        var { data } = await Repository.getRepo("DeleteConfig47", payload);
        if (data.result == "ok") {
          await this.QuerySearch();
          if (localStorage.language == "En") {
            this.$swal("", "Apply successfully", "success");
    ...
    async LoadComponent() {
      ...
      var { data } = await Repository.getRepo("GetConfig47Content", payload);
      this.DataTable = [];
