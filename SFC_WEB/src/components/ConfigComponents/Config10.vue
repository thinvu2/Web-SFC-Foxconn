  ...
  <div class="div-all">
    <div class="row">
      ...
      <div class="div-config-name row">
        <span>Config Location Setup (10):</span>
      </div>
    </div>
    ...
    <div class="div-bellow">
      <div class="form-row">
        ...
        <div class="col-md-3 mb-3">
          <label for="validationDefault02">LOCATION DESC</label>
          <input
            type="text"
            class="form-control form-control-sm text-element"
            id="validationDefault01"
        ...
        <div class="col-md-3 mb-3">
          <label for="validationDefault02">SIDE</label>
          <input
            type="number"
            max="2"
            min="1"
      ...
      <div class="form-row">        
        <div class="col-md-3 mb-3">
          <label for="validationDefault02">ITEM SERIAL</label>
          <input
            type="text"
            class="form-control form-control-sm text-element"
            id="validationDefault01"
            v-model="model.ITEM_TYPE"
            required
          />
        </div>
        <div class="col-md-3 mb-3">
          <label for="validationDefault02">MFR CODE</label>
          <input
            type="text"
            class="form-control form-control-sm text-element"
            id="validationDefault01"
            v-model="model.MFR_CODE"
            required
          />
        </div>
        <div class="col-md-3 mb-3">
          <label for="validationDefault02">MFR NAME</label>
          <input
            type="text"
            class="form-control form-control-sm text-element"
            id="validationDefault01"
            v-model="model.MFR_NAME"
          />
        </div>
      </div>
    </div>
...
export default {
  ...
  methods: {
    ...
    async SaveData() {
      if (this.model.ERROR_CODE == "" || this.model.ERROR_DESC == "") {
    ...
    DeleteRecord(item) {
      ...
      this.$swal({
        ...
        var { data } = await Repository.getRepo("DeleteConfig10", payload);
        if (data.result == "ok") {
          await this.QuerySearch();
          if (localStorage.language == "En") {
            this.$swal("", "Apply successfully", "success");
    ...
    ClearForm() {
      ...
      this.model.ITEM_SERIAL = "";
      this.model.ITEM_NAME = "";
      this.model.ITEM_TYPE = "";
      this.model.SIDE = "";
      this.model.MFR_CODE = "";
      this.model.MFR_NAME = "";
    },
    ShowDetail(detail) {
      ...
      this.model.MODEL_CODE = detail.MODEL_CODE;
      this.model.MODEL_NAME = detail.MODEL_NAME;
      this.model.ITEM_CODE = detail.ITEM_CODE;
      this.model.ITEM_SERIAL = detail.ITEM_SERIAL;
      this.model.ITEM_NAME = detail.ITEM_NAME;
      this.model.ITEM_TYPE = detail.ITEM_TYPE;
      this.model.SIDE = detail.SIDE;
      this.model.MFR_CODE = detail.MFR_CODE;
      this.model.MFR_NAME = detail.MFR_NAME;
    },
    BackToParent() {
    ...
    async LoadComponent() {
      ...
      var { data } = await Repository.getRepo("GetConfig10Content", payload);
      this.DataTable = [];
