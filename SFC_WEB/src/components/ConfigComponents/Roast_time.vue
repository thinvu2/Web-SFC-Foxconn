      ...
      <div class="form-row">
        ...
        <div class="col-md-3 mb-3">  
          <label for="validationDefault01">DEFAULT_GROUP</label>
            <DropdownSearch class="form-control form-control-sm text-element" 
            type="model"
...
export default {
  ...
  methods: {
    ...
    async SaveData() {
      ...
      if (this.model.MODEL_NAME == null || this.model.DEFAULT_GROUP == null || this.model.END_GROUP == null ) {
        ...
        this.$swal({
          ...
          var { data } = await Repository.getRepo("InsertUpdateRoast_time",payload);
    ...
    async LoadComponent() {
      ...
      var { data } = await Repository.getRepo("GetConfigRoast_timeContent", payload);
      this.DataTable = [];
