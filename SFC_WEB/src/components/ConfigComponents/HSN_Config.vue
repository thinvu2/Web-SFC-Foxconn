  ...
  <div class="div-all">
    ...
    <div class="div-bellow">
      <div class="form-row">
        ...
        <div class="col-md-4 mb-4">
          <label for="validationDefault02">KP_HSN</label>
...
export default {
  ...
  methods: {
    ...
    async GetModel() {
      ...
      var { data } = await Repository.getRepo("HSN_CONFIGGetAllModel", payload);
    ...
    async SaveData() {
      if (this.model.MODEL_NAME == "" || this.model.GROUP_NAME == "") {        
    ...
    DeleteRecord(item) {
      ...
      this.$swal({
        ...
        var { data } = await Repository.getRepo("DeleteHSN_Config", payload);
        if (data.result == "ok") {
          await this.QuerySearch();
          if (localStorage.language == "En") {
            this.$swal("", "Apply successfully", "success");
    ...
    async LoadComponent() {
      ...
      var { data } = await Repository.getRepo("getHSN_Config", payload);
      this.DataTable = [];
