  ...
  <div class="div-all">
    <div class="row">
      ...
      <div class="div-config-name row">
        <span>Config Customer Setup (14):</span>
      </div>
    </div>
    ...
    <div class="div-bellow">
      <div class="form-row">
        ...
        <div class="col-md-4 mb-3">
          <label for="validationDefault02">PASSWD</label>
          <input
            type="text"
            class="form-control form-control-sm text-element"
            id="validationDefault01"
        ...
        <div class="col-md-4 mb-3">
          <label for="validationDefault02">CUST CODE</label>
          <input
            type="text"
            class="form-control form-control-sm text-element"
            id="validationDefault01"
            v-model="model.CUST_CODE"
          />
        </div>
      </div>
    </div>
  ...
  methods: {
    ...
    DeleteRecord(item) {
      ...
      this.$swal({
        ...
        var { data } = await Repository.getRepo("DeleteConfig14", payload);
        if (data.result == "ok") {
          await this.QuerySearch();
          if (localStorage.language == "En") {
            this.$swal("", "Apply successfully", "success");
    ...
    ShowDetail(detail) {
      ...
      this.model.PASSWD = detail.PASSWD;
    ...
    async LoadComponent() {
      ...
      var { data } = await Repository.getRepo("GetConfig14Content", payload);
      this.DataTable = [];
