  ...
  <div class="div-all">
    ...
    <div class="div-bellow">
      <div class="form-row">
        ...
        <div class="col-md-3 mb-3">  
          <label for="validationDefault02">ATTRIBUTE_VALUE</label>
            <DropdownSearch class="form-control  text-element" 
            type="model"
            :textContent="model.ATTRIBUTE_VALUE"
            :listAll="ListATTRIBUTE_VALUE"
            textPlaceHolder="Enter ATTRIBUTE_VALUE"
            @update-selected-item="UpdateValueReceive" />
        </div>

        <div class="col-md-3 mb-3">  
          <label for="validationDefault02">ATTRIBUTE_DESC1</label>
            <DropdownSearch class="form-control text-element" 
            type="model"
            :textContent="model.ATTRIBUTE_DESC1"
            :listAll="ListATTRIBUTE_DESC1"
            textPlaceHolder="Enter ATTRIBUTE_DESC1"
            @update-selected-item="UpdateDescReceive" />
        </div>
...
export default {
  ...
  methods: {
    UpdateModelReceive(value) {
        this.model.TYPE_VALUE = value;
        this.model.ATTRIBUTE_VALUE = "";
        this.model.ATTRIBUTE_DESC1 = "";
        this.model.ID = "";     
    },
    ...
    UpdateValueReceive(value) {
      this.model.ATTRIBUTE_VALUE = value;     
    },  
    ...
    async GetModel() {
      ...
      var { data } = await Repository.getRepo("ConfigJIGModel", payload);
      data.data.forEach((element) => {
        this.ListModel.push(element.MODEL_NAME);
      });
      data.dtvalue.forEach((element) => {
        this.ListATTRIBUTE_VALUE.push(element.ATTRIBUTE_VALUE);
      });
      data.dtdesc.forEach((element) => {
        this.ListATTRIBUTE_DESC1.push(element.ATTRIBUTE_DESC1);
      });
    },
    ...
    async SaveData() {
      if (this.model.TYPE_VALUE == null || this.model.ATTRIBUTE_DESC1 == null || this.model.ATTRIBUTE_VALUE == null ) {
        ...
        this.$swal({
          ...
          var payload = {
            ...
            ATTRIBUTE_DESC1: this.model.ATTRIBUTE_DESC1,
            ATTRIBUTE_VALUE: this.model.ATTRIBUTE_VALUE,   
          };

          var { data } = await Repository.getRepo("InsertUpdateJIG",payload);
    ...
    DeleteRecord(item) {
      ...
      this.$swal({
        ...
        var { data } = await Repository.getRepo("DeleteJIG", payload);
        if (data.result == "ok") {
          await this.QuerySearch();
          if (localStorage.language == "En") {
            this.$swal("", "Apply successfully", "success");
    ...
    ShowDetail(detail) {
        ...
        this.model.TYPE_VALUE = detail.TYPE_VALUE;
        this.model.ATTRIBUTE_DESC1 = detail.ATTRIBUTE_DESC1;
        this.model.ATTRIBUTE_VALUE = detail.ATTRIBUTE_VALUE;
    },
    BackToParent() {
    ...
    async LoadComponent() {
      ...
      var { data } = await Repository.getRepo("GetConfigJIGContent", payload);
      this.DataTable = [];
