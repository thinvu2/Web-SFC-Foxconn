  ...
  <div class="div-all">
    ...
    <div class="div-bellow">
      <div class="form-row">
        <div class="col-md-3 mb-3">
          ...
          <DropdownSearch
            ...
            :listAll="ListCustomer"
            @update-selected-item="UpdateCustReceive"
            :textContent="model.CUST_NAME"
            type="customer"
            textPlaceHolder="Enter customer name"
          />
        </div>
        <div class="col-md-3 mb-3">
          <label for="validationDefault02">CUST SN LENGTH</label>
          <input
            type="number"
        ...
        <div class="col-md-3 mb-3">
          <label for="validationDefault01">CUST SN STR</label>
          <input
            type="text"
            class="form-control form-control-sm text-element"
      ...
      <div class="form-row">
        ...
        <div class="col-md-3 mb-3">
          <label for="validationDefault02">CUST BOX PREFIX</label>
          <input
            type="text"
            class="form-control form-control-sm text-element"
            id="validationDefault02"
        ...
        <div class="col-md-3 mb-3">
          <label for="validationDefault01">CUST MODEL NAME</label>
          <input
            type="text"
            class="form-control form-control-sm text-element"
            id="validationDefault01"
        ...
        <div class="col-md-3 mb-3">
          <label for="validationDefault02">CUST BOX LENGTH</label>
          <input
            type="number"
            class="form-control form-control-sm text-element"
            id="validationDefault02"
      ...
      <div class="form-row">
        <div class="col-md-3 mb-3">
          <label for="validationDefault02">CUST VERSION CODE</label>
          <input
            type="text"
            class="form-control form-control-sm text-element"
            id="validationDefault02"
        ...
        <div class="col-md-3 mb-3">
          <label for="validationDefault01">CUST BOX STR</label>
          <input
            type="text"
            class="form-control form-control-sm text-element"
            id="validationDefault01"
        ...
        <div class="col-md-3 mb-3">
          <label for="validationDefault02">CUST MODEL DESC</label>
          <input
            type="text"
            class="form-control form-control-sm text-element"
            id="validationDefault02"
        ...
        <div class="col-md-3 mb-3">
          <label for="validationDefault02">CUST CARTON PREFIX</label>
          <input
            type="text"
            class="form-control form-control-sm text-element"
            id="validationDefault02"
      ...
      <div class="form-row">
        <div class="col-md-3 mb-3">
          <label for="validationDefault01">UPCEANDATA (TA)</label>
          <input
            type="text"
            class="form-control form-control-sm text-element"
            id="validationDefault01"
        ...
        <div class="col-md-3 mb-3">
          <label for="validationDefault02">CUST CARTON LENGTH</label>
          <input
            type="number"
            class="form-control form-control-sm text-element"
            id="validationDefault02"
        ...
        <div class="col-md-3 mb-3">
          <label for="validationDefault02">CUST SN PREFIX</label>
          <input
            type="text"
            class="form-control form-control-sm text-element"
            id="validationDefault02"
        ...
        <div class="col-md-3 mb-3">
          <label for="validationDefault01">CUST CARTON STR</label>
          <input
            type="text"
            class="form-control form-control-sm text-element"
            id="validationDefault01"
      ...
      <div class="form-row">
        <div class="col-md-3 mb-3">
          <label for="validationDefault02">CUST VENDER CODE</label>
          <input
            type="text"
            class="form-control form-control-sm text-element"
            id="validationDefault02"
            v-model="model.CUST_VENDER_CODE"
            required
          />
        </div>
        <div class="col-md-3 mb-3">
          <label for="validationDefault02">CUST PALLET PREFIX</label>
          <input
            type="text"
            class="form-control form-control-sm text-element"
            id="validationDefault02"
        ...
        <div class="col-md-3 mb-3">
          <label for="validationDefault01">CUST SN POSTFIX</label>
          <input
            type="text"
            class="form-control form-control-sm text-element"
            id="validationDefault01"
            v-model="model.CUST_SN_POSTFIX"
            required
          />
        </div>
        <div class="col-md-3 mb-3">
          <label for="validationDefault02">CUST PALLET POSTFIX</label>
          <input
            type="text"
            class="form-control form-control-sm text-element"
            id="validationDefault02"
      ...
      <div class="form-row">
        <div class="col-md-3 mb-3">
          <label for="validationDefault02">SN QTY / LABEL</label>
          <input
            type="number"
            class="form-control form-control-sm text-element"
            id="validationDefault02"
        ...
        <div class="col-md-3 mb-3">
          <label for="validationDefault01">CUST PALLET LENGTH</label>
          <input
            type="number"
            class="form-control form-control-sm text-element"
            id="validationDefault01"
        ...
        <div class="col-md-3 mb-3">
          <label for="validationDefault02">MACID PREFIX</label>
          <input
            type="text"
            class="form-control form-control-sm text-element"
            id="validationDefault02"
            v-model="model.MACID_PREFIX"
            required
          />
        </div>
        <div class="col-md-3 mb-3">
          <label for="validationDefault02">CUST PALLET STR</label>
          <input
            type="text"
            class="form-control form-control-sm text-element"
            id="validationDefault02"
      ...
      <div class="form-row">
        <div class="col-md-3 mb-3">
          <label for="validationDefault02">PALLET LABEL NAME</label>
          <input
            type="text"
            readonly
            class="form-control form-control-sm text-element"
        ...
        <div class="col-md-3 mb-3">
          <label for="validationDefault02">CARTON LABEL NAME</label>
          <input
            type="text"
            readonly
            class="form-control form-control-sm text-element"
