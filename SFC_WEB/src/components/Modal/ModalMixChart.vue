<template>
  <div class="div_route">
    <transition name="fade" appear>
      <div
        class="modal-overlay"
        v-if="$store.state.isShowMixChart"
        @click="$emit('hideModal')"
      ></div>
    </transition>
    <transition name="slide" appear>
      <div class="my_modal" v-if="$store.state.isShowMixChart">
...
export default {
  ...
  data() {
    return {
      series: this.$store.state.mixChartSeries,
      chartOptions: this.$store.state.mixChartOption,
    };
  },
  methods: {},
};
