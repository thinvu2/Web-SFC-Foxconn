...
namespace SN_API.Services
{
    ...
    {
        public static string UI = StringConnect("10.220.81.198", "1527", "SFCODB", "HOGAN", "sfcsystem2014#!");
        ...
        public static string NIC_STANDBY = StringConnect("10.220.96.201", "1521", "VNSFC", "SFIS1", "VNSFIS2014#!");
        ...
        public static string AIR = StringConnect("10.220.81.200", "1527", "SFCODB", "SFIS1", "hift2013!");
        ...
        public static string AP2 = StringConnect("10.220.81.99", "1521", "VNAP", "AP2", "NSDAP2LOGPD0522");
